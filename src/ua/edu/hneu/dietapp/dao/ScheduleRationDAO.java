...
public class ScheduleRationDAO extends ContentProvider {

	public static String TABLE_NAME = "schedule_ration";
	public static final String ID = "_id";
	public static final String SCH_ID = "schedule_id";
	public static final String RAT_ID = "ration_id";
	...
	static {
		...
		mContactMap.put(SCH_ID, SCH_ID);
		mContactMap.put(RAT_ID, RAT_ID);
	}
