...
public class TypeProductDAO extends ContentProvider {

	public static String TABLE_NAME = "type_product";
	...
	public static final Uri CONTENT_URI = Uri
			.parse("content://ua.edu.hneu.dietapp.typeproductprovider/diet");
